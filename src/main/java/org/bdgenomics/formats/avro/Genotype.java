...
public class Genotype extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** Phred scaled likelihoods that we have n non-reference alleles at this site.
   The number of elements in this array should be equal to the ploidy at this
   site, plus 1. */
  @Deprecated public java.util.List<java.lang.Integer> nonReferenceLikelihoods;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 12: genotypeLikelihoods = (java.util.List<java.lang.Integer>)value$; break;
    case 13: nonReferenceLikelihoods = (java.util.List<java.lang.Integer>)value$; break;
   ...
   * Phred scaled likelihoods that we have n non-reference alleles at this site.
   The number of elements in this array should be equal to the ploidy at this
   site, plus 1.   */
  public java.util.List<java.lang.Integer> getNonReferenceLikelihoods() {
   ...
   */
  public void setNonReferenceLikelihoods(java.util.List<java.lang.Integer> value) {
   ...
   * Component statistics which comprise the Fisher's Exact Test to detect strand bias.   * @param value the value to set.
   */
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Genotype>
    ...
    private java.util.List<java.lang.Integer> nonReferenceLikelihoods;
    ...
    /** Sets the value of the 'genotypeLikelihoods' field */
    public org.bdgenomics.formats.avro.Genotype.Builder setGenotypeLikelihoods(java.util.List<java.lang.Integer> value) {
    ...
    /** Sets the value of the 'nonReferenceLikelihoods' field */
    public org.bdgenomics.formats.avro.Genotype.Builder setNonReferenceLikelihoods(java.util.List<java.lang.Integer> value) {
    ...
    public Genotype build() {
      try {
        ...
        record.genotypeLikelihoods = fieldSetFlags()[12] ? this.genotypeLikelihoods : (java.util.List<java.lang.Integer>) defaultValue(fields()[12]);
        record.nonReferenceLikelihoods = fieldSetFlags()[13] ? this.nonReferenceLikelihoods : (java.util.List<java.lang.Integer>) defaultValue(fields()[13]);
